...
- `debian-patches/fcitx5/noble-compat.patch`: debhelper-compat 14→13，删 plasma-wayland-protocols dep
- `debian-patches/librime/noble-compat.patch`: 删 libmarisa-dev / libopencc-dev / libutfcpp-dev / libyaml-cpp-dev 版本约束
- `debian-patches/fcitx5-chinese-addons/noble-compat.patch`: debhelper-compat 14→13，删 libopencc-dev 版本约束（noble 有 1.1.7，要求 1.1.9~）
